  ...
  if (error && selectedDoctorId) {
    return (
      <div className="max-w-4xl mx-auto px-4 py-20 text-center">
        ...
        <Link to="/opportunities" className="btn btn-outline mt-6 inline-flex">
    ...
    <div className="fade-in text-left">
      <section className="hero-gradient py-12">
        <div className="max-w-4xl mx-auto px-4">
          <Link to="/opportunities" className="text-sm text-slate-500 hover:text-teal-700 flex items-center gap-1">
            <ArrowLeft className="w-4 h-4" /> Back to opportunities
          </Link>
          <h1 className="font-display font-extrabold text-3xl md:text-4xl text-navy-800 mt-4">
            {bookingMode === 'reschedule' ? 'Reschedule Session' : 'Book a Session'}
          </h1>
          <p className="text-slate-600 mt-2">
            {bookingMode === 'reschedule'
              ? 'Update your existing session date or time slot with our medical professionals.'
              : 'Schedule an appointment with our verified medical professionals.'}
          </p>
        </div>
      </section>

      <section className="max-w-4xl mx-auto px-4 py-12">
        <div className="card card-pad bg-white max-w-2xl mx-auto">
          {submitted ? (
            <div className="text-center py-8">
              ...
              <h2 className="font-display font-bold text-2xl text-navy-800">
                {bookingMode === 'reschedule' ? 'Session Rescheduled!' : 'Appointment Booked!'}
              </h2>
              <p className="text-slate-600 mt-2">
              ...
              {bookingMode === 'reschedule' && !selectedAppointment ? (
                ...
                <div className="space-y-4">
                  <div className="flex flex-col gap-1">
                    <label className="label">Find Appointment by Patient Name</label>
                ...
                <div className="space-y-4">
                  <div className="flex flex-col gap-1">
                    <label className="label">Find Appointment to Cancel by Patient Name</label>
                    <div className="flex gap-2">
                      <input
                        type="text"
                        className="input"
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="relative select-container w-full">
                    <label className="label">Search/Select Doctor</label>
                    <input
                      type="text"
                    ...
                    {isDropdownOpen && filteredDoctors.length > 0 && (
                      ...
                      >
                        {filteredDoctors.map(doc => (
                          ...
                          >
                            <div className="font-semibold text-navy-800 text-sm">{doc.name}</div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input 
                        ...
                        readOnly 
                        className="input bg-slate-50 cursor-not-allowed text-slate-600 font-semibold" 
                    ...
                    <div>
                      ...
                      <input 
                        ...
                        readOnly 
                        className="input bg-slate-50 cursor-not-allowed text-slate-600" 
                        placeholder="Choose doctor..."
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    <label className="label">Patient Name (User booking appointment)</label>
                    <input 
                      type="text" 
                      required 
                      value={patientName}
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    ...
                    <div>
                      ...
                      <input 
                        ...
                        readOnly 
                        value={day}
                        className="input bg-slate-50 cursor-not-allowed font-semibold text-slate-500" 
                  ...
                  <div className="pt-4 border-t border-slate-100 flex gap-3">
                    ...
                    {bookingMode === 'reschedule' && selectedAppointment ? (
                      ...
                      <Link to="/opportunities" className="btn btn-outline">Cancel</Link>
                    )}
                  </div>
                </form>
              )}
